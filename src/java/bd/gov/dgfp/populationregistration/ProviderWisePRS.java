 ...
 * @author Helal
 */
@WebServlet(name = "ProviderWisePRS", urlPatterns = {"/provider-wise-prs"})
public class ProviderWisePRS extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Menu.setMenu("POPULATION REGISTRATION", "provider-wise-prs", request);
        request.getRequestDispatcher("WEB-INF/jsp/newPopulationRegistration/ProviderWisePRS.jsp").forward(request, response);
    }
