 ...
 * @author Helal
 */
@WebServlet(name = "ViewNotACitizen", urlPatterns = {"/viewNotACitizen"})
public class ViewNotACitizen extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                ...
                String query="select \"HHNo\", \"NameEng\", \"Father\", \"DOB\",\n" +
                                ...
                                "from \"Member\" \n" +
                                "where \"HaveNID\"='2' and \"NIDStatus\"='7' and \"Age\">='18'  \n" +
                ...
                try {
                        ...
                        RequestDispatcher view = request.getRequestDispatcher("WEB-INF/jsp/viewNotACitizen.jsp");
