 ...
 * @author shahaz
 */
@WebServlet(name = "ReportingUnionJsonProvider", urlPatterns = {"/ReportingUnionJsonProvider"})
public class ReportingUnionJsonProvider extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String where="where zillaid = " + zillaId + " and upazilaid = " + upazilaId+" and upazilaid not in (999)";
