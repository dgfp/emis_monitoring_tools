 ...
 */
@WebServlet(name = "ReleaseNotes", urlPatterns = {"/Release-note"})
public class ReleaseNotes extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Menu.setMenu("RESOURCES", "Release-note", request);
        request.getRequestDispatcher("WEB-INF/jsp/resources/release-notes.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!filename.isEmpty()) {
            String dirname=getServletContext().getRealPath("resources/release-notes");
