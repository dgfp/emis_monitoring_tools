...
@WebServlet(name = "MIS1", urlPatterns = {"/MIS1"})
public class MIS1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("WEB-INF/jsp/reports/MIS1.jsp");
