...
@WebServlet(name = "MIS_Form_1_ServletTest", urlPatterns = {"/mis-form-1_"})
public class MIS_Form_1_ServletTest extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("WEB-INF/jsp/reports/mis-form-1Test.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String provCode = "93087";// request.getParameter("provCode");
        ...
        if (action.equalsIgnoreCase("showdata")) {
            try {
                ...
                if (isSubmitable) {
                    ...
                    data += ",\"submissionId\":" + submissionId + ",\"modrep\":" + modeRep + ",\"status\":" + isApprove + "}";
...
//                }
    ...
    private ArrayList<String> getMis1RealData(String divisionId, String districtId, String upazilaId, String unionId, String fwaUnit, String month, String year, String date, String[] dates, String provCode) {
        ...
        try {
            ...
            String query = "select * from public.fn_mis_form1_ka_new("+districtId+","+upazilaId+","+unionId+","+fwaUnit+","+year+","+month+");";
            String query2 = "select * from public.fn_mis_form1_kha_ga_gha_uma_cha ("+districtId+","+upazilaId+","+unionId+","+fwaUnit+","+year+","+month+");";
            ...
            ResultSet result2 = db2.select(query2);
            ...
            mis1.add(responseJson3); // LMIS
            mis1.add(jsonObject); //CSBA
