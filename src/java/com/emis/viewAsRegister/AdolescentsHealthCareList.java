 ...
 */
@WebServlet(name = "AdolescentsHealthCareList", urlPatterns = {"/AdolescentsHealthCareList"})
public class AdolescentsHealthCareList extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.setAttribute("submenu", "AdolescentsHealthCareList");
        request.setAttribute("menu", "VIEW AS REGISTER");
        RequestDispatcher view = request.getRequestDispatcher("WEB-INF/jsp/viewAsRegister/AdolescentsHealthCareList.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (districtId != "" || upazilaId != "" || unionId != "" || unitId != "") {
            try {
                ...
                String sql = "select * from web_adolescents_health_care_list(?,?,?,?,?,?,?)";
                System.out.println("SQL: select * from web_adolescents_health_care_list(" + divisionId + "," + districtId + ",'" + upazilaId + "','" + unionId + "','" + unitId + "','" + startDate + "','" + endDate + "')");
