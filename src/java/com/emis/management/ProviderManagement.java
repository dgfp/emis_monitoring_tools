 ...
 */
@WebServlet(name = "ProviderManagement", urlPatterns = {"/provider-management"})
public class ProviderManagement extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Menu.setMenu("MANAGEMENT", "provider-management", request);
        request.getRequestDispatcher("WEB-INF/jsp/management/ProviderManagement.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("showdata")) {
            ...
            try {
                ...
                Logger.getLogger(ProviderManagement.class.getName()).log(Level.SEVERE, null, ex);
            }
