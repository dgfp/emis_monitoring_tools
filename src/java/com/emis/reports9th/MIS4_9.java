 ...
 * @author Helal
 */
@WebServlet(name = "MIS4_9", urlPatterns = {"/MIS_4"})
public class MIS4_9 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String view = "WEB-INF/jsp/reports9th/mis-4-9.jsp";
        ...
        try {
            if (request.getSession(false).getAttribute("district") != null) {
                if (new UserDao().isPaperless(request.getSession(false).getAttribute("district").toString())) {
                    response.sendRedirect(request.getContextPath() + "/MIS_4_DGFP");
                } else {
...
//        Menu.setMenu("VIEW REPORTS", "MIS_4", request);
//        request.getRequestDispatcher("WEB-INF/jsp/reports9th/mis-4-9.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("submitReport")) {
            ...
            try {
                //get supervisor code
                providerId = Service.getUFPOByUpazila(districtId, upazilaId) + "";
                ...
                mis4_ngo.put("supervisorid", supervisorCode + "");
                ...
                mis4_versatile.put("supervisorid", supervisorCode + "");
    ...
    private JSONArray getMIS4(String districtId, String upazilaId, String providerId, String month, String year, Boolean returnAsSubmitted) {
        ...
        try {
            String query = "SELECT * from public.web_mis4_report_9v_rakib (" + districtId + ", " + upazilaId + "," + providerId + "," + year + "," + month + ") where is_approved=1 and active=1";
...
//            }
    ...
    private Boolean isSubmitable(String districtId, String upazilaId, String month, String year) {
        ...
        try {
            ...
            String sql = "  SELECT * FROM public.web_report_submission where modrep=? and zillaid=? and upazilaid=? and month=? and year=?";
    ...
    private String ngoSQLGenerator(JSONObject ngoObj) throws JSONException {
        ...
        String query = "INSERT INTO rpt_mis_form4_ufpo_9v (%s) VALUES (%s) ON CONFLICT(%s) DO UPDATE SET (%s)=row(%s);";
