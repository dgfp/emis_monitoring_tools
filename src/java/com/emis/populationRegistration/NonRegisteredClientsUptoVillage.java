 ...
 * @author Nibras
 */
@WebServlet(name = "NonRegisteredClientsVillage", urlPatterns = {"/non-registered-clients-village"})
public class NonRegisteredClientsUptoVillage extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Menu.setMenu("POPULATION REGISTRATION", "non-registered-clientsvillage", request);
        request.getRequestDispatcher("WEB-INF/jsp/populationRegistration/NonRegisteredClientsUptoVillage.jsp").forward(request, response);
    }
