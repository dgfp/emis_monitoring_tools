...
@WebServlet(name = "NidPossessionStatus", urlPatterns = {"/NidPossessionStatus"})
public class NidPossessionStatus extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        request.setAttribute("submenu", "NidPossessionStatus");
        ...
        RequestDispatcher view = request.getRequestDispatcher("WEB-INF/jsp/newPopulationRegistration/nid_possession_status_updated.jsp");
...
//        String endDate = Convertor.convertToCustomDateFormat( request.getParameter("endDate").toString());
            ...
            if(districtId.equals("%")){
                ...
                try {
                    ...
                    for (int district : districtIdList){
                        ...
                        query = "select * from sp_possessionnid_dist("+divisionId+",'"+districtId+"','"+startDate+"','"+endDate+"');";
        ...
        if (action.equals("showUpazilaWise")) {
            ...
            query = "select * from sp_possessionnid_upz("+districtId+",'"+upazilaId+"','"+startDate+"','"+endDate+"');";
        ...
        if (action.equals("showUnionWise")) {
            ...
            query = "select * from sp_possessionnid_un("+districtId+","+upazilaId+",'"+unionId+"','"+startDate+"','"+endDate+"');";
        }
        ...
        if (action.equals("prsProgressProviderWise")) {
            ...
            query= "select * from web_nid_providerwise('"
                        + districtId
                        + "','"
                        + upazilaId
                        + "','"
