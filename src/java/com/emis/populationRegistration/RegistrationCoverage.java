 ...
 * @author Helal
 */
@WebServlet(name = "RegistrationCoverage", urlPatterns = {"/ProgressOfPopulationRegistration"})
public class RegistrationCoverage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("submenu", "ProgressOfPopulationRegistration");
        ...
        RequestDispatcher view = request.getRequestDispatcher("WEB-INF/jsp/populationRegistration/registrationCoverage.jsp");
