 ...
 * @author Helal
 */
@WebServlet(name = "DivisionJsonProviderByUserProviderAccess", urlPatterns = {"/DivisionJsonProviderByUserProviderAccess"})
public class DivisionJsonProviderByUserProviderAccess extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                ...
                ResultSet result= db.select("SELECT distinct id, division, divisioneng FROM public.implemented_div_zila "+where+" and provider_access_active=1  order by divisioneng asc");
