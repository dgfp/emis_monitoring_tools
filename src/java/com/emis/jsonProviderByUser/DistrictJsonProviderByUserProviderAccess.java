 ...
 * @author Helal
 */
@WebServlet(name = "DistrictJsonProviderByUserProviderAccess", urlPatterns = {"/DistrictJsonProviderByUserProviderAccess"})
public class DistrictJsonProviderByUserProviderAccess extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet result = db.select("select distinct zillaid, zillaname, zillanameeng  from implemented_div_zila "+where+" and is_implemented=1 and provider_access_active=1  order by zillanameeng asc");
