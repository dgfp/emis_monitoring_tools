 ...
 * @author Helal
 */
@WebServlet(name = "UpazilaJsonProviderByUserProviderAccess", urlPatterns = {"/UpazilaJsonProviderByUserProviderAccess"})
public class UpazilaJsonProviderByUserProviderAccess extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "select distinct zillaid, upazilaid, upazilaname, upazilanameeng  from implemented_div_zila " + where + " and is_implemented=1 and provider_access_active=1 order by upazilanameeng asc";
