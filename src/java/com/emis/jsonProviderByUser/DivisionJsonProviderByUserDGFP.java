 ...
 * @author Helal
 */
@WebServlet(name = "DivisionJsonProviderByUserDGFP", urlPatterns = {"/DivisionJsonProviderByUserDGFP"})
public class DivisionJsonProviderByUserDGFP extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String where = "where is_implemented=1 and is_paperless=1";

            if (!(division == null || division == "0")) {
                where = "where is_implemented=1 and is_paperless=1 and id='" + division + "'";
            }
