...
<script src="resources/js/area_dropdown_control_by_user_mis2_bangla_dgfp.js"></script>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.input-group-approve', '#form-report-response').find('button').click(function (e) {
            ...
            if (isValided) {
                $.ajax({
                    url: "MIS_2_DGFP?action=submitReport&subType=" + json.status,
                    data: {
...
//                    +"<td class='left'>"+val.provname+" - "+val.providerid+"</td>"
                ...
                $.each(json.providers, function (index, val) {
                    ...
                    if (json.fpiSubmittedJson[index] != undefined) {
                        var fpi = "";
                        if (index == 0) {
                            fpi = "<td rowspan='10' class='text-center'><input type='number' class='form-control input-nsv' min=0 name='fortnightly_meeting_fpi_" + val.fwaunit + "' id='fortnightly_meeting_fpi' value='" + json.fpiSubmittedJson[index].fortnightly_meeting_fpi + "'  disabled/></td>"
                                    + "<td rowspan='10' class='text-center'><input type='number' class='form-control input-nsv' min=0 name='union_fp_committee_fpi_" + val.fwaunit + "' id='union_fp_committee_fpi' value='" + json.fpiSubmittedJson[index].union_fp_committee_fpi + "' disabled/></td>";
                        }
                        var tbody = "<tr>"
                                + "<td class='text-center'>" + $.app.units[val.fwaunit][1] + "<input type='hidden' class='form-control' min=0 name='unit_" + val.fwaunit + "' id='unit' value='" + val.fwaunit + "' /><input type='hidden' class='form-control' min=0 name='providerid_" + val.fwaunit + "' id='providerid' value='" + val.providerid + "' /><input type='hidden' class='form-control' min=0 name='supervisorcode_" + val.fwaunit + "' id='supervisorcode' value='" + $("select#provCode").val() + "' /></td>"
                                + "<td class='text-center'><input type='number' class='form-control input-nsv' min=0 name='nsv_inspired_fpi_" + val.fwaunit + "' id='nsv_inspired_fpi' value='" + json.fpiSubmittedJson[index].nsv_inspired_fpi + "' /></td>"
                                + "<td class='text-center'><input type='number' class='form-control input-nsv' min=0 name='av_van_display_fpi_" + val.fwaunit + "' id='av_van_display_fpi' value='" + json.fpiSubmittedJson[index].av_van_display_fpi + "' /></td>"
                                + "<td class='text-center'><input type='number' class='form-control input-nsv' min=0 name='elco_day_count_fpi_" + val.fwaunit + "' id='elco_day_count_fpi'  value='" + json.fpiSubmittedJson[index].elco_day_count_fpi + "' disabled/></td>"
                                + "<td class='text-center'><input type='number' class='form-control input-nsv' min=0 name='no_of_elco_count_fpi_" + val.fwaunit + "' id='no_of_elco_count_fpi' value='" + json.fpiSubmittedJson[index].no_of_elco_count_fpi + "' disabled/></td>"
                                + "<td class='text-center'><input type='number' class='form-control input-nsv' min=0 name='fwa_register_fpi_" + val.fwaunit + "' id='fwa_register_fpi' value='" + json.fpiSubmittedJson[index].fwa_register_fpi + "' /></td>"
                                + "<td class='text-center'><input type='number' class='form-control input-nsv' min=0 name='yard_meeting_fpi_" + val.fwaunit + "' id='yard_meeting_fpi' value='" + json.fpiSubmittedJson[index].yard_meeting_fpi + "' /></td>"
                                + fpi + "<td class='text-center'><input type='number' class='form-control input-nsv' min=0 name='satellite_clinic_presence_fpi_" + val.fwaunit + "' id='satellite_clinic_presence_fpi' value='" + json.fpiSubmittedJson[index].satellite_clinic_presence_fpi + "' /></td>"
                                + "</tr>";
                        $('#nsv-submit-tbody').append(tbody);
                    }
                });
...
//                                    $("#mis2Page10").append("<tr class='submitted'>\n" + mis2.renderRow(mis2.pageLength[10], '&nbsp;', $.getUnitName(json[i].r_unit, 1), "") + "</tr>");
        ...
        $('#exportToDHIS2Button').on('click', function (event) {
            $.ajax({
                url: "MIS_2_DGFP?action=exportToDHIS2",
                data: {
