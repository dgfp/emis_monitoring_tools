...
<script src="resources/js/area_dropdown_control_by_user_mis4_bangla_dgfp.js"></script>
<script src="resources/js/TemplateMIS.js" type="text/javascript"></script>
<script src="resources/js/$.mis4_dgfp.js"></script>
...
/*    .callout.callout-success, .callout.callout-danger, .callout.callout-warning {
    ...
    #descendantSubmissionStatusTable{
        font-size: 11px;
    ...
    <c:if test="${sessionScope.designation=='UFPO' || sessionScope.role=='Super admin'}">
    .color1{
...
<section class="content">
    ...
    <div id="viewStatus">
                ...
                <div id="descendantSubmissionStatus" class="text-center">
                    <table id="descendantSubmissionStatusTable" class="mis_table" style="background-color: #fff; width: 400px;float: none;margin: 0 auto;"></table>
                </div>
    ...
    <div class="box box-primary full-screen">
            ...
            <%-- ONLY UFPO WOULD BE ABLE TO SEE THE LEGEND --%>
            <c:if test="${sessionScope.designation=='UFPO' || sessionScope.role=='Super admin'}">
