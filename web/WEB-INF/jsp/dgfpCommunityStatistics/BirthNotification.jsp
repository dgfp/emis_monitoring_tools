<%-- 
    Document   : Birth Notification
    Created on : Apr 22, 2021, 9:44:57 AM
    Author     : Helal
--%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@include file="/WEB-INF/jspf/templateHeaderELCO.jspf" %>
<script src="resources/js/area_dropdown_birth_death.js"></script>
<script>
    $(function () {
    ...
    $(document).ready(function () {
        ...
        $('input[type=radio][name=reportType]').change(function () {
            if (this.value == "aggregate") {
                ...
                $("#dateBlock").fadeIn();
                $("#_periodical").fadeIn();
                $("#_atPoint, #_monthly, #_yearly").fadeOut();
            }
        ...
        $('#showdataButton').click(function () {
            ...
            $("#tableView, #graphView, .prs-info, .status-info").fadeOut();
            ...
            //Periodic
            if (data.viewType == "periodical" && data.periodicalStartDate == "" && data.reportType != "individual") {
                toast("error", "Please select date");
                return;
            } else if (data.viewType == "periodical" && data.periodicalEndDate == "" && data.reportType != "individual") {
                toast("error", "Please select date");
                return;
            ...
            if (data.reportType === "individual") {
                ...
                $.ajax({
                    url: "birth-notification?action=aggregate",
                    data: {
                    ...
                    success: function (json) {
                        ...
                        //
                        renderIndividual(elco, json);

                        reportTitle = "List of registered birth between " + data.periodicalStartDate +" and "+data.periodicalEndDate;
...
//==================================================at a point
                        if (data.viewType == 'atPoint' || data.reportType == "individual") {
                            ...
                            parsedHeader = "<tr>"
                                    ...
                                    + "<th style='vertical-align: top;'>Birth data collection</th>"
                                    + "</tr>";
                            elco.tableHeader.append(parsedHeader);
                            elco.tableHeaderP.append(parsedHeader);
                            ...
                            if ($("select#upazila").val() == '0') {
                                ...
                                for (var i = 0; i < json.length; i++) {
                                    var parsedData = "<tr id='centerAlign'><td>" + (i + 1) + "</td>"
                                            ...
                                            + "<td id='centerAlign'>" + (parseInt(json[i].live_birth) || 0) + "</td></tr>";
                                ...
                                for (var i = 0; i < json.length; i++) {
                                    ...
                                    var parsedData = "<tr id='centerAlign'><td>" + (i + 1) + "</td>"
                                            ...
                                            + "<td class='area'>ID: " + json[i].providerid + " - " + provname + "<br/>Mob: " + ((json[i].providermobile === "null") ? "-" : json[i].providermobile) + "</td>"
                                            + "<td id='centerAlign'>" + finiteFilter(json[i].registered_population) + "</td>"
                                            + "<td id='centerAlign'>" + (parseInt(json[i].live_birth) || 0) + "</td></tr>";
                                    elco.tableBody.append(parsedData);
                                    elco.tableBodyP.append(parsedData);
                            ...
                            var footerData = "<tr> <td style='text-align:left' colspan='" + colspan + "'>" + getTotalText() + " Total</td>"
                                    ...
                                    + "<td id='centerAlign'>" + cal.sum.live_birth + "</td></tr>";
                            ...
                            $.each(json, function (index, value) {
                                chartData.push({area: value[area], progress: value.live_birth});
                            });
                            chartData.push({area: getTotalText() + " Total", progress: cal.sum.live_birth}); // Total bar
                            $.chart.renderBirthDeathBar(chartId, chartData, ['Birth data'], chartColor[data.viewType], 0);
                            //Report title
...
//================================periodical
                            ...
                            parsedHeader += "<th style='vertical-align: top;'>Birth data collection</th>"
                                    + "</tr>";
                            ...
                            if ($("select#upazila").val() == '0') {
                                ...
                                $.each(json, function (k, v) {
                                    var parsedData = "<tr id='centerAlign'><td>" + (k + 1) + "</td>"
                                            ...
                                            + "<td id='centerAlign'>" + (parseInt(v.live_birth) || 0) + "</td>"
                                            + "</tr>";
                                    elco.tableBody.append(parsedData);
                                    elco.tableBodyP.append(parsedData);
                                });
                                ...
                                $.each(json, function (k, v) {
                                    ...
                                    var parsedData = "<tr id='centerAlign'><td>" + (k + 1) + "</td>"
                                            ...
                                            + "<td class='area'>ID: " + v.providerid + " - " + provname + "<br/>Mob: " + ((v.providermobile === "null") ? "-" :  v.providermobile) + "</td>"
                                            + "<td id='centerAlign'>" + (parseInt(v.live_birth) || 0) + "</td>"
                                            + "</tr>";
                                    elco.tableBody.append(parsedData);
                                    elco.tableBodyP.append(parsedData);
                            ...
                            var cal = new Calc(json);
                            var footerData = "<tr> <td style='text-align:left' colspan='" + colspan + "'>" + getTotalText() + " Total</td>"
                                    + "<td id='centerAlign'>" + cal.sum.live_birth + "</td>"
                                    + "</tr>";
                            elco.tableFooter.append(footerData);
                            elco.tableFooterP.append(footerData);
                            //DataTable
...
//================================monthly
                            ...
                            if ($("select#upazila").val() == '0') {
                                $.each(getDistinct(json, 'upazilanameeng'), function (i, v) {
                                    ...
                                    $.each(months, function (index, value) {
                                        console.log("Start:-");
                                        birth = json.filter(obj => obj.upazilanameeng == v && obj.months == value.months && obj.years == value.years)[0];
                                        console.log(birth);
                                        parsedData += "<td style='font-weight: normal!important;'>" + birth.live_birth + "</td>";
                                        chartDataObj["month_" + index] = birth.live_birth;
                                    });
                                    parsedHeader += "</tr>";
                                    elco.tableBody.append(parsedData);
                                    elco.tableBodyP.append(parsedData);
                                ...
                                $.each(getDistinct(json, 'reporting_union_name'), function (i, v) {
                                    ...
                                    $.each(months, function (index, value) {
                                        console.log("Start:-");
                                        birth = json.filter(obj => obj.reporting_union_name == v && obj.months == value.months && obj.years == value.years)[0];
                                        console.log(birth);
                                        parsedData += "<td style='font-weight: normal!important;'>" + birth.live_birth + "</td>";
                                        chartDataObj["month_" + index] = birth.live_birth;
                                    });
                                ...
                                $.each(getDistinct(json, 'uname'), function (i, v) {
                                    ...
                                    var parsedData = "<tr><td>" + (i + 1) + "</td>"
                                            ...
                                            + "<td class='area'>ID: " + obj.providerid + " - " + provname + "<br/>Mob: " + ((obj.providermobile === "null") ? "-" :  obj.providermobile) + "</td>";
                                    $.each(months, function (index, value) {
                                        birth = json.filter(obj => obj.uname == v && obj.months == value.months && obj.years == value.years)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + birth.live_birth + "</td>";
                                        chartDataObj["month_" + index] = birth.live_birth;
                                    });
                                    parsedHeader += "</tr>";
                            ...
                            $.each(months, function (index, value) {
                                ...
                                footerData += "<td>" + cal.sum.live_birth + "</td>"
                                chartDataObj["month_" + index] = cal.sum.live_birth;
                            });
                            chartData.push(chartDataObj);
                            elco.tableFooter.append(footerData);
                            elco.tableFooterP.append(footerData);
                            ...
                            $("#data-table").DataTable($.app.dtOptions());
                            //Chart render
                            $.chart.renderBirthDeathBar(chartId, chartData, chartLabel, chartColor[data.viewType], 0);
                            //Report title
...
//================================Yearly
                            ...
                            if ($("select#upazila").val() == '0') {
                                $.each(getDistinct(json, 'upazilanameeng'), function (i, v) {
                                    ...
                                    var parsedData = "<tr><td>" + (i + 1) + "</td>"
                                            + "<td>" + v + "</td>";
                                    $.each(years, function (index, value) {
                                        birth = json.filter(obj => obj.upazilanameeng == v && obj.years == value).length == 0 ? 0 : json.filter(obj => obj.upazilanameeng == v && obj.years == value)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + birth.live_birth + "</td>";
                                        chartDataObj["year_" + index] = birth.live_birth;
                                    });
                                    parsedHeader += "</tr>";
                                    elco.tableBody.append(parsedData);
                                    elco.tableBodyP.append(parsedData);
                                ...
                                $.each(getDistinct(json, 'reporting_union_name'), function (i, v) {
                                    ...
                                    var parsedData = "<tr><td>" + (i + 1) + "</td>"
                                            + "<td>" + v + "</td>";
                                    $.each(years, function (index, value) {
                                        birth = json.filter(obj => obj.reporting_union_name == v && obj.years == value).length == 0 ? 0 : json.filter(obj => obj.reporting_union_name == v && obj.years == value)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + birth.live_birth + "</td>";
                                        chartDataObj["year_" + index] = birth.live_birth;
                                    });
                                    parsedHeader += "</tr>";
                                ...
                                $.each(getDistinct(json, 'uname'), function (i, v) {
                                    ...
                                    $.each(years, function (index, value) {
                                        birth = json.filter(obj => obj.uname == v && obj.years == value).length == 0 ? 0 : json.filter(obj => obj.uname == v && obj.years == value)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + birth.live_birth + "</td>";
                                        chartDataObj["year_" + index] = birth.live_birth;
                                    });
                                    parsedHeader += "</tr>";
                            ...
                            $.each(getDistinct(json, 'years'), function (index, value) {
                                ...
                                footerData += "<td>" + cal.sum.live_birth + "</td>"
                                chartDataObj["year_" + index] = cal.sum.live_birth;
                            });
                            chartData.push(chartDataObj);
                            elco.tableFooter.append(footerData);
                            elco.tableFooterP.append(footerData);
        ...
        //Functions
        var viewTitle = {
            atPoint: 'Number of registered birth on',
            monthly: 'Number of registered birth against registered population between',
            yearly: 'Number of registered birth between',
            periodical: 'Number of birth registered between',
            undefined: 'List of registered birth between' //Individual
        };
//        var viewTitle = {
...
//        };
        ...
        function getProgrerss_(json) {
            var progress = ((parseInt(json.registered_pregnant_women) || 0) / (parseInt(json.estimated_pregnant_women) || 0)) * 100;
        ...
        function renderIndividual(elco, json) {
            var table = $('#data-table').DataTable();
            table.destroy();
            elco.tableBody.empty();
            for (var i = 0; i < json.length; i++) {
                var mobile = "";//json[i].mobileno === "null" ? "-" : "0" + json[i].mobileno;
                if(json[i].mobileno === "null" || json[i].mobileno === "undefined"){
                    mobile = "-";
                }
                if (json[i].fathermobile !== "null") {
                    mobile = "0" +json[i].fathermobile;
                } else if (json[i].mothermobile !== "null") {
                    mobile = "0" +json[i].mothermobile;
                }
                var parsedData = "<tr><td>" + (i + 1) + "</td>"
                        + "<td style='vertical-align: top;'>" + json[i].villagenameeng + "</td>"
                        + "<td style='vertical-align: top;' class='area'>" + json[i].nameeng + "</td>"
                        + "<td style='vertical-align: top;' class='area'>" + ((json[i].fathername === "null") ? "-" : json[i].fathername) + "</td>"
                        + "<td style='vertical-align: top;' class='area'>" + ((json[i].mothername === "null") ? "-" : json[i].mothername) + "</td>"
                        + "<td style='vertical-align: top;'>" + mobile + "</td>"
                        + "<td style='vertical-align: top;'>" + $.app.date(json[i].date_of_birth).date + "</td>"
                        + "<td style='vertical-align: top;'>" + json[i].place_of_birth + "</td></tr>";
                elco.tableBody.append(parsedData);
                elco.tableBodyP.append(parsedData);
            }
            $("#data-table").DataTable($.app.dtOptions());
...
<section class="content-header"> 
    <h1>Birth notification<small></small></h1>
</section>
...
<!--                            <div class="col-md-2 col-xs-6">
    ...
    <!--    <div class="row info-box-md-container status-info">
            <div class="col-md-3 col-xs-6">
                <div class="info-box bg-white status-box">
                    <span class="info-box-icon bg-blue"><i class="fa fa-venus" aria-hidden="true"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text"><h4></h4></span>
                        <span class="info-box-number center box-title">Total : &nbsp;&nbsp;<span id="totalPregnant">0</span></span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-xs-6">
                <div class="info-box bg-white status-box">
                    <span class="info-box-icon bg-green"><i class="fa fa-check-circle-o" aria-hidden="true"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text"><h4></h4></span>
                        <span class="info-box-number center box-title">Active : &nbsp;&nbsp;<span id="activePregnant">0</span></span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-xs-6">
                <div class="info-box bg-white status-box">
                    <span class="info-box-icon bg-red"><i class="fa fa-times-circle-o" aria-hidden="true"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text"><h4></h4></span>
                        <span class="info-box-number center box-title">Due : &nbsp;&nbsp;<span id="duePregnant">0</span></span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-xs-6">
                <div class="info-box bg-white status-box">
                    <span class="info-box-icon bg-aqua"><i class="fa fa-check-square-o" aria-hidden="true"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text"><h4></h4></span>
                        <span class="info-box-number center box-title">Completed : &nbsp;&nbsp;<span id="completedPregnant">0</span></span>
                    </div>
                </div>
            </div>
        </div>-->
    ...
    <div class="box box-primary full-screen" id="tableView">
        <div class="box-header with-border" style="padding: 0px;">
            <!--            <div class="form-inline" id="sort-by" style="padding: 0px 5px">
                            <div class="form-group">
                                <label for="email">Sort by &nbsp;</label>
                                <select class="form-control input-xs" style="width: 130px;height: 30px;" aria-hidden="true" name="filter" id="filter" >
                                    <option value="all">Total</option>
                                    <option value="current">Currently pregnant</option>
                                    <option value="completed">Pregnancy completed</option>
                                </select>
                            </div>
                        </div>-->
    ...
    <div class="box box-primary full-screen" id="graphView">
        <div class="box-header with-border" style="padding: 0px;">
            ...
            <div class="box-tools pull-right" style="margin-top: -10px;">
                ...
                <a href="#" id="exportImageChart" download="birth_notification.png" target="_blank" class="btn btn-flat btn-default btn-xs bold"><i class="fa fa-file-image-o" aria-hidden="true"></i>&nbsp;Image</a>
                <button type="button" class="btn btn-box-tool" id="panel-fullscreen"><i class="fa fa-expand" aria-hidden="true"></i></button>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        $('#exportPrint').click(function () {
            ...
            frameDoc.document.write('<h3 style="margin-bottom:-12px;text-align:center!important;"><center>Birth notification</center></h3>');
        ...
        $('#exportPrintChart').click(function () {
            ...
            //Append the DIV contents.
            frameDoc.document.write('<h3 style="margin-bottom:-12px;text-align:center"><center>Birth notification</center></h3>');
            frameDoc.document.write('<h3 style="margin-bottom:-12px;text-align:center!important;"><center>' + $('.viewTitle > .label').html() + '</center></h3>');
        ...
        $("#exportText").click(function (event) {
            var outputFile = "eMIS_birth_notification";
