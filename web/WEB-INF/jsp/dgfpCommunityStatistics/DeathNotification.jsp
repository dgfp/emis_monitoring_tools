<%-- 
    Document   : Death Notification
    Created on : Apr 22, 2021, 9:45:19 AM
    Author     : Helal
--%>
    ...
    $(document).ready(function () {
        ...
        $('#showdataButton').click(function () {
            ...
            if (data.reportType === "individual") {
                ...
                $.ajax({
                    url: "death-notification?action=aggregate",
                    data: {
                    ...
                    success: function (json) {
                        ...
                        var parsedHeader = "<tr>"
                                ...
                                + "<th style='vertical-align: top;'>Age at death</th>"
                        ...
                        reportTitle = "List of registered death between " + data.periodicalStartDate + " and " + data.periodicalEndDate;
...
//==================================================at a point
                        if (data.viewType == 'atPoint' || data.reportType == "individual") {
                            ...
                            parsedHeader = "<tr>"
                                    ...
                                    + "<th style='vertical-align: top;'>Death data collection</th>"
                                    + "</tr>";
                            elco.tableHeader.append(parsedHeader);
                            elco.tableHeaderP.append(parsedHeader);
                            ...
                            if ($("select#upazila").val() == '0') {
                                ...
                                for (var i = 0; i < json.length; i++) {
                                    var parsedData = "<tr id='centerAlign'><td>" + (i + 1) + "</td>"
                                            ...
                                            + "<td id='centerAlign'>" + (parseInt(json[i].reg_death) || 0) + "</td></tr>";
                            ...
                            var footerData = "<tr> <td style='text-align:left' colspan='" + colspan + "'>" + getTotalText() + " Total</td>"
                                    ...
                                    + "<td id='centerAlign'>" + cal.sum.reg_death + "</td></tr>";
                            ...
                            $.each(json, function (index, value) {
                                chartData.push({area: value[area], progress: value.reg_death});
                            });
                            chartData.push({area: getTotalText() + " Total", progress: cal.sum.reg_death}); // Total bar
                            $.chart.renderBirthDeathBar(chartId, chartData, ['Death data'], chartColor[data.viewType], 0);
                            //Report title
...
//================================periodical
                            ...
                            parsedHeader += "<th style='vertical-align: top;'>Death data collection</th>"
                                    + "</tr>";
                            ...
                            if ($("select#upazila").val() == '0') {
                                ...
                                $.each(json, function (k, v) {
                                    var parsedData = "<tr id='centerAlign'><td>" + (k + 1) + "</td>"
                                            ...
                                            + "<td id='centerAlign'>" + (parseInt(v.reg_death) || 0) + "</td>"
                                            + "</tr>";
                                    elco.tableBody.append(parsedData);
                                    elco.tableBodyP.append(parsedData);
                                });
                            ...
                            var cal = new Calc(json);
                            var footerData = "<tr> <td style='text-align:left' colspan='" + colspan + "'>" + getTotalText() + " Total</td>"
                                    + "<td id='centerAlign'>" + cal.sum.reg_death + "</td>"
                                    + "</tr>";
                            elco.tableFooter.append(footerData);
                            elco.tableFooterP.append(footerData);
                            //DataTable
...
//================================monthly
                            ...
                            if ($("select#upazila").val() == '0') {
                                $.each(getDistinct(json, 'upazilanameeng'), function (i, v) {
                                    ...
                                    $.each(months, function (index, value) {
                                        death = json.filter(obj => obj.upazilanameeng == v && obj.months == value.months && obj.years == value.years)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + death.reg_death + "</td>";
                                        chartDataObj["month_" + index] = death.reg_death;
                                    });
                                    parsedHeader += "</tr>";
                                    elco.tableBody.append(parsedData);
                                    elco.tableBodyP.append(parsedData);
                                ...
                                $.each(getDistinct(json, 'reporting_union_name'), function (i, v) {
                                    ...
                                    var parsedData = "<tr><td>" + (i + 1) + "</td><td>" + v + "</td>";
                                    $.each(months, function (index, value) {
                                        death = json.filter(obj => obj.reporting_union_name == v && obj.months == value.months && obj.years == value.years)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + death.reg_death + "</td>";
                                        chartDataObj["month_" + index] = death.reg_death;
                                    });
                                ...
                                $.each(getDistinct(json, 'uname'), function (i, v) {
                                    ...
                                    $.each(months, function (index, value) {
                                        death = json.filter(obj => obj.uname == v && obj.months == value.months && obj.years == value.years)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + death.reg_death + "</td>";
                                        chartDataObj["month_" + index] = death.reg_death;
                                    });
                                    parsedHeader += "</tr>";
                            ...
                            $.each(months, function (index, value) {
                                ...
                                footerData += "<td>" + cal.sum.reg_death + "</td>"
                                chartDataObj["month_" + index] = cal.sum.reg_death;
                            });
                            chartData.push(chartDataObj);
                            elco.tableFooter.append(footerData);
                            elco.tableFooterP.append(footerData);
...
//================================Yearly
                            ...
                            if ($("select#upazila").val() == '0') {
                                $.each(getDistinct(json, 'upazilanameeng'), function (i, v) {
                                    ...
                                    var parsedData = "<tr><td>" + (i + 1) + "</td>"
                                            + "<td>" + v + "</td>";
                                    $.each(years, function (index, value) {
                                        death = json.filter(obj => obj.upazilanameeng == v && obj.years == value).length == 0 ? 0 : json.filter(obj => obj.upazilanameeng == v && obj.years == value)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + death.reg_death + "</td>";
                                        chartDataObj["year_" + index] = death.reg_death;
                                    });
                                    parsedHeader += "</tr>";
                                    elco.tableBody.append(parsedData);
                                    elco.tableBodyP.append(parsedData);
                                ...
                                $.each(getDistinct(json, 'reporting_union_name'), function (i, v) {
                                    ...
                                    var parsedData = "<tr><td>" + (i + 1) + "</td>"
                                            + "<td>" + v + "</td>";
                                    $.each(years, function (index, value) {
                                        death = json.filter(obj => obj.reporting_union_name == v && obj.years == value).length == 0 ? 0 : json.filter(obj => obj.reporting_union_name == v && obj.years == value)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + death.reg_death + "</td>";
                                        chartDataObj["year_" + index] = death.reg_death;
                                    });
                                    parsedHeader += "</tr>";
                                ...
                                $.each(getDistinct(json, 'uname'), function (i, v) {
                                    ...
                                    $.each(years, function (index, value) {
                                        death = json.filter(obj => obj.uname == v && obj.years == value).length == 0 ? 0 : json.filter(obj => obj.uname == v && obj.years == value)[0];
                                        parsedData += "<td style='font-weight: normal!important;'>" + death.reg_death + "</td>";
                                        chartDataObj["year_" + index] = death.reg_death;
                                    });
                                    parsedHeader += "</tr>";
                            ...
                            $.each(getDistinct(json, 'years'), function (index, value) {
                                ...
                                footerData += "<td>" + cal.sum.reg_death + "</td>"
                                chartDataObj["year_" + index] = cal.sum.reg_death;
                            });
                            chartData.push(chartDataObj);
                            elco.tableFooter.append(footerData);
                            elco.tableFooterP.append(footerData);
        ...
        //Functions
        var viewTitle = {
            atPoint: 'Number of registered death',
            monthly: 'Number of registered death against registered population between',
            yearly: 'Number of registered death between',
            periodical: 'Number of death registered between',
            undefined: 'List of registered death between' //Individual
        };
//        var viewTitle = {
        ...
        function renderIndividual(elco, json) {
            ...
            for (var i = 0; i < json.length; i++) {
                var parsedData = "<tr><td>" + (i + 1) + "</td>"
                        ...
                        + "<td style='vertical-align: top;'>" + $.app.date(json[i].date_of_death).date + "</td>"
                        + "<td style='vertical-align: top;'>" + json[i].calculated_age.split('-').join(' ') + "</td>"
                        + "<td style='vertical-align: top;'>" + json[i].place_of_death + "</td></tr>";
                elco.tableBody.append(parsedData);
                elco.tableBodyP.append(parsedData);
            }
            $("#data-table").DataTable($.app.dtOptions());
...
<section class="content-header"> 
    <h1>Death notification<small></small></h1>
</section>
    ...
    <div class="box box-primary full-screen" id="graphView">
        <div class="box-header with-border" style="padding: 0px;">
            ...
            <div class="box-tools pull-right" style="margin-top: -10px;">
                ...
                <a href="#" id="exportImageChart" download="death_notification.png" target="_blank" class="btn btn-flat btn-default btn-xs bold"><i class="fa fa-file-image-o" aria-hidden="true"></i>&nbsp;Image</a>
                <button type="button" class="btn btn-box-tool" id="panel-fullscreen"><i class="fa fa-expand" aria-hidden="true"></i></button>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        $('#exportPrint').click(function () {
            ...
            frameDoc.document.write('<h3 style="margin-bottom:-12px;text-align:center!important;"><center>Death notification</center></h3>');
        ...
        $('#exportPrintChart').click(function () {
            ...
            //Append the DIV contents.
            frameDoc.document.write('<h3 style="margin-bottom:-12px;text-align:center"><center>Death notification</center></h3>');
            frameDoc.document.write('<h3 style="margin-bottom:-12px;text-align:center!important;"><center>' + $('.viewTitle > .label').html() + '</center></h3>');
        ...
        $("#exportText").click(function (event) {
            var outputFile = "eMIS_death_notification";
