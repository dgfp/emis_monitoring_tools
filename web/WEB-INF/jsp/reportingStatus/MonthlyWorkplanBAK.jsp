        ...
        $.MAWDashboard = $.MAWDashboard || {
            ...
            ajax: {
                ...
                statusLoader: function (area) {
                    $('#dashboard').empty();
                    $.ajax({
                        url: "MonthlyWorkplanBAK?action=getStatus",
                        type: "POST",
                ...
                getProviderList: function (type) {
                    $.ajax({
                        url: "MonthlyWorkplanBAK?action=getProviderList&type=" + type,
                        type: "POST",
...
//                                    {data: "mobileno", title: 'Mobile'},
                ...
                getWorkplan: function (json) {
                    $.ajax({
                        url: "MonthlyWorkplanBAK?action=getWorkplan",
                        type: "POST",
                        data: json,
//                    data: {
