...
<style>
    ...
    @media print {
        ...
        .mis2   { display: block; page-break-before: always; margin-top: 5px; }
        .page1{
...
//            } else {
            ...
            Pace.track(function () {
                $.ajax({
                    ...
                    data: {
                        divisionId: 50,
                        districtId: 69, //$("select#district").val(),
                        upazilaId: 9, //$("select#upazila").val(),
                        unionId: 57, //$("select#union").val(),
                        providerId: 691017,
                        month: 3, //$("select#month").val(),
                        year: 2018 //$("select#year").val()
...
//                        year: $("select#year").val()
                    ...
                    success: function (result) {
                        ...
                        /*
                         ...
                         var page1 = i == (9 - json.length) ? getLastRow(cal, 1) : getRow(37, '&nbsp;');
                         $('#mis2Page1').append("<tr>\n" + page1 + "</tr>");
                         
                         var page2 = i == (9 - json.length) ? getLastRow(cal, 2) : getRow(36, '&nbsp;');
                         $('#mis2Page2').append("<tr>\n" + page2 + "</tr>");
                         
                         var page3 = i == (9 - json.length) ? getLastRow(cal, 3) : getRow(28, '&nbsp;');
                         $('#mis2Page3').append("<tr>\n" + page3 + "</tr>");
                         
                         var page4 = i == (9 - json.length) ? getLastRow(cal, 4) : getRow(29, '&nbsp;');
                         $('#mis2Page4').append("<tr>\n" + page4 + "</tr>");
                         
                         //$('#mis2Page3').append("<tr>\n" + getRow(28, false ? '<span class="r-v">সর্বমোট</span>' : '&nbsp;') + "</tr>");
                         //$('#mis2Page4').append("<tr>\n" + getRow(29, false ? '<span class="r-v">সর্বমোট</span>' : '&nbsp;') + "</tr>");
                         }
                         */
        ...
        function renderRow(length, text, unit) {
...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <div class="box-tools pull-right" style="margin-top: -10px;">
                <button type="button" class="btn btn-box-tool" onclick="window.print();"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Print / PDF</button>
        ...
        <div class="box-body" id="data-table">
            <div class="col-ld-12 ">
                <div class="col-md-12 mis-form-1"  style="padding: -30px;">
                    <div class="mis2">
                        <div class="table-responsive" >
                            <table  style="text-align: left; table-layout: fixed; width: 100%;border: 1!important;" id="topHeader">
                                <tr>
                                    ...
                                    <th style="text-align:center;border:none!important;" colspan="2">
                                        <small>গনপ্রজাতন্ত্রী বাংলাদেশ সরকার<br>স্বাস্থ্য ও পরিবার পরিকল্পনা মন্ত্রনালয়<br>পরিবার পরিকল্পনা অধিদপ্তর</small>
                                        <br>পরিবার পরিকল্পনা, মা ও শিশু স্বাস্থ্য কার্যক্রমের মাসিক অগ্রগতির প্রতিবেদন
                                    </th>
                                    <th style="text-align:right;border:none!important;" id="page">এম আই এস ফরম - ২<br>পৃষ্ঠা-১</th>
                                </tr>
                                <tr>
                        ...
                        <div class="table-responsive">
                            <table style=" width: 100%;text-align: left!important" class="page1 mis_table tg">
                                <tr>
                                    ...
                                    <th colspan="35" class="center">পরিবার পরিকল্পনা পদ্ধতি গ্রহনকারী</th>
                                </tr>
                                <tr>
                            ...
                            <table class="table-bordered mis_table pull-right" style="width: 80%;">
                                                    <tbody>
                                                        <tr>
                    ...
                    <div class="table-responsive mis2" data-mis2="page2">
                        <table style="width: 100%" class="mis_table tg">
                                                        ...
                                                        <tr>
                                                            <td rowspan="4"><span class="r-v">ইউনিট নম্বর<span></td>
                                                                        <th colspan="35" class="center"><b>প্রজনন স্বাস্থ্য সেবা</b></th>
                                                                        </tr>
                                                                        <tr>
                    ...
                    <div class="table-responsive mis2" data-mis2="page3">
                        <table style="width: 100%" class="mis_table tg">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th colspan="12" class="center"><b>শিশু (০-৫ বছর) সেবা</b></th>
                                                                                    <th colspan="12" class="center"><b>জন্ম-মৃত্যু</b></th>
                                                                                </tr>
                                                                                <tr>
                    ...
                    <div class="table-responsive mis2" data-mis2="page4">
                        <table style="width: 100%" class="mis_table tg">
                            ...
                            <tr>
                                <td rowspan="4"><span class="r-v">ইউনিট নম্বর</span></td>
                                <th colspan="18" class="center"><b>পুষ্টি সেবা</b></th>
                                <td rowspan="4" ><span class="r-v">চলতি মাসে নবদম্পতির সংখ্যা</span></td>
                                <th colspan="9" class="center"><b>এফপিআই কর্তৃক প্রদত্ত সেবা কার্যক্রম</b></th>
                            </tr>
                            <tr>
                    ...
                    <div class="table-responsive mis2" data-mis2="page5">
                        <table style="width: 100%" class="mis_table tg">
                            ...
                            <tr>
                                <td rowspan="4"><span class="r-v">ইউনিট নম্বর</span></td>
                                <th colspan="26" class="center"><b>সিএসবিএ কর্তৃক প্রদত্ত সেবার তথ্য<br>(প্রজনন স্বাস্থ্য সেবা)</b></th>
                            </tr>
                            <tr>
                    ...
                    <div class="mis2">
                        ...
                        <div class="row">
                            <h4 class="center">    জন্মনিরোধক সামগ্রী ও অন্যান্য দ্রব্যাদির মাসিক সংকলিত প্রতিবেদন     </h4>
...
<script>
    $(document).ready(function () {
        $('#printTableBtn').click(function () {
            ...
            frameDoc.document.write('<style>table, th, td{border:1px solid black; border-collapse: collapse;padding:10px;}th{vertical-align: text-center} td{text-align:center;} .left{text-align:left;} #topheader{border: none;}</style>');
