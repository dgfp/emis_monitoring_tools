...
//                Pace.track(function () {
                $.ajax({
                    url: "mis-form-1_?action=showdata",
                    data: {
                        divisionId: $("select#division").val(),
                        districtId: $("select#district").val(),
                        upazilaId: $("select#upazila").val(),
...
//                            } else {
//                                alert.append(getAlert("No data found","danger"));
//                            }
//                            btn.button('reset');
...
<section class="content-header">
    <h1 id="pageTitle">
        ...
        </span> <span id="title">MIS 1 and CSBA report (Development)</span>
...
<!--                <div class="col-md-1 col-xs-2">
            ...
            <div class="row">
                <div class="col-md-2 col-xs-4 col-md-offset-10 col-xs-offset-2 submitButton">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <div class="box box-chat box-default  direct-chat direct-chat-warning">
                    <div class="box-body">
                        <!--                        <a class="btn btn-flat btn-info btn-sm" id="viewLatest"><i class="fa fa-envelope-open-o" aria-hidden="true"></i> <b>&nbsp;View Latest</b></a>-->
