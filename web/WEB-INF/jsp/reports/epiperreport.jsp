...
<section class="content-header">
    <h1 id="pageTitle"> FWA Daily tally sheet</h1>
</section>
                            ...
                            <div class="col-md-12">
                                <table class="mis_table" style="width: 1620px">
                                    ...
                                    <tr id="r_pill_old">
                                        ...
                                        <td  rowspan="32" class="rotate center"><div style="width:40px" class="text-nowrap"> পরিবার পরিকল্পনা পদ্ধতি গ্রহণ সংক্রান্ত তথ্যের হিসাব</div></td>
                                        <td rowspan="5" class="rotate center">খাবার বড়ি</td>
