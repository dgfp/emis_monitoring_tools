...
//======Reset all - Dashboard - Data view type buttons - graph - map - table
        function resetAllDataPresenter() {
            ...
            $('#presentationType,#mapView,#tableView,#graphView').hide();
        ...
        function getDashboard(household, population) {
            return  '<div class="col-lg-6 col-xs-6 no-margin">'
                    ...
                    + '<div class="info-box bg-white">\
                        ...
                        <span class="info-box-text"><h4>'+ finiteFilter(household)+'%</h4></span>\
                        <span class="info-box-number">Household</span>\
                        </div>\
                        </div>'
                    + '</div>'
                    + '<div class="col-md-6">'
                    + '<div class="info-box bg-white">\
                       <span class="info-box-icon bg-yellow"><i class="fa fa-users"></i></span>\
                        <div class="info-box-content">\
                        <span class="info-box-text"><h4>'+ finiteFilter(population)+'%</h4></span>\
                        <span class="info-box-number">Population</span>\
                        </div>\
                        </div>'
                    + '</div>'
                    + '</div>'
                    ...
                    + '<div class="row" id="presentationType">'
                    + '<div class="col-md-6">'
                    + '<div class="info-box bg-white clickable" id="graphViewByBtnClick">\
                        <span class="info-box-icon bg-aqua" id="graphImgBackground"><img id="graphImg" src="resources/icon/graph.png" alt=""></span>\
                        <div class="info-box-content clickable">\
                        <span class="info-box-text"><h4></h4></span><br>\
                        <span class="info-box-number">Chart View</span>\
                        </div>\
                        </div>'
                    + '</div>'
                    + '<div class="col-md-6">'
                    + '<div class="info-box bg-white clickable" id="tableViewByBtnClick">\
                        <span class="info-box-icon bg-aqua" id="tableImgBackground"><img id="graphImg" src="resources/icon/table.png" alt=""></span>\
                        <div class="info-box-content clickable">\
                        <span class="info-box-text"><h4></h4></span><br>\
