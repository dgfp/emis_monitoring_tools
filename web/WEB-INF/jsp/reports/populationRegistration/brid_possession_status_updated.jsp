<%-- 
    Document   : brid_possession_status_updated
    Created on : Aug 3, 2017, 9:21:22 AM
    Author     : Helal
--%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@include file="/WEB-INF/jspf/templateHeader.jspf" %>
<script src="resources/TemplateJs/Chart.bundle.js" type="text/javascript"></script>
<!--<script src="resources/TemplateJs/jspdf.js" type="text/javascript"></script>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#printChartBtn').click(function () {
            ...
            frameDoc.document.write('<h3 style="margin-bottom:-12px;text-align:center"><center> Possession of Birth Registration Card - ' + type + ' wise</center></h3>');
...
//        }
        $('#printTableBtn').click(function () {
            ...
            frameDoc.document.write('<link href="style.css" rel="stylesheet" type="text/css" />');
            //Append the DIV contents.
            frameDoc.document.write('<h3 style="margin-bottom:-12px;"><center> Possession of Birth Registration Card - ' + type + ' wise</center></h3>');
...
//        $('#pdfTableBtn').click(function () {
//            var table = tableToJson($('#data-table').get(0));
...
//        });
        ...
        $("#exportText").click(function (event) {
            var outputFile = "eMIS_birth_registration_id_coverage";
...
//=====================NID Report View Type eND====================================================================================
        ...
        $('#showDistrictPRS').click(function () {
            ...
            if (divisionId === "") {
                ...
                Pace.track(function () {
                    $.ajax({
                        url: "BRidPossessionStatusUpdated?action=showDistrictWise",
                        data: {
                        ...
                        success: function (result) {
                            ...
                            if (json.length === 0) {
                                ...
                                //Make stacked and pie chart
                                if (json.length == 1) {
                                    $.chart.renderPIE(json, chart, $.chart.BRID);
                                } else {
                                    $.chart.BRID.area = 'distname';
                                    $.chart.renderBAR(json, chart, $.chart.BRID);
                                }
                                //End <-Chart-Upazila->=====================================
...
//                                    +"<th style='vertical-align: text-top'>Eligible(18+)</th>"
                                        + "<th style='vertical-align: text-top'>Have BRID card (%)</th>"
                                ...
                                var registered_sum = 0, eligible_sum = 0, havenbrid_sum = 0,
                                        never_had_sum = 0, lost_sum = 0, cant_locate_sum = 0, kept_in_other_place_sum = 0, not_citizen_sum = 0;
...
//                                            + "<td id='rightAlign'>" + json[i].eligible + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((json[i].havenbrid / json[i].registered * 100).toFixed(2)) + "</td>"
//                                            + "<td id='rightAlign'>" + json[i].percent + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((json[i].never_had / json[i].registered * 100).toFixed(2)) + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((json[i].lost / json[i].registered * 100).toFixed(2)) + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((json[i].cant_locate / json[i].registered * 100).toFixed(2)) + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((json[i].kept_in_other_place / json[i].registered * 100).toFixed(2)) + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((json[i].not_citizen / json[i].registered * 100).toFixed(2)) + "</tr>";
...
//                                    eligible_sum += json[i].eligible;
                                    havenbrid_sum += json[i].havenbrid;
                                    never_had_sum += json[i].never_had;
                                    lost_sum += json[i].lost;
                                    cant_locate_sum += json[i].cant_locate;
                                    kept_in_other_place_sum += json[i].kept_in_other_place;
                                    not_citizen_sum += json[i].not_citizen;
                                }

                                if (registered_sum > 0 || havenbrid_sum > 0
                                        || never_had_sum > 0 || lost_sum > 0 || cant_locate_sum || cant_locate_sum > 0
                                        || kept_in_other_place_sum > 0 || not_citizen_sum > 0
                                        ) {
...
//                                            + "<td id='rightAlign'>" + eligible_sum + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((havenbrid_sum / registered_sum * 100).toFixed(2)) + "</td>"
//                                            + "<td id='rightAlign'>" + ((havenbrid_sum / registered_sum) * 100).toFixed(2) + "</td>"                                      
                                            + "<td id='rightAlign'>" + parseFloat((never_had_sum / registered_sum * 100).toFixed(2)) + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((lost_sum / registered_sum * 100).toFixed(2)) + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((cant_locate_sum / registered_sum * 100).toFixed(2)) + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((kept_in_other_place_sum / registered_sum * 100).toFixed(2)) + "</td>"
                                            + "<td id='rightAlign'>" + parseFloat((not_citizen_sum / registered_sum * 100).toFixed(2)) + "</tr>";
        ...
        $('#showUpazilaPRS').click(function () {
            ...
            if (divisionId === "") {
                ...
                Pace.track(function () {
                    $.ajax({
                        url: "BRidPossessionStatusUpdated?action=showUpazilaWise",
                        data: {
                            districtId: districtId,
                            upazilaId: upazilaId,
                            startDate: startDate,
                        ...
                        success: function (result) {
                            ...
                            if (json.length === 0) {
                                ...
                                if (json.length == 1) {
                                    ...
                                    $.chart.BRID.area = 'upname';
                                    $.chart.renderBAR(json, chart, $.chart.BRID);

                                    //chart.append(getChart()); //Get Chart portion div
                                    //makeChart(area, HaveBRIDCardData, NeverHadData, LostData, CantLocateData, KeptInOtherPlaceData, NotCitizenData);
                                }
                                //End <-Chart-Upazila->=====================================
...
//                                            + "<td id='rightAlign'>" + ((havenbrid_sum / registered_sum) * 100).toFixed(2) + "</td>"                                      
        ...
        $('#showUnionPRS').click(function () {
            ...
            if (divisionId === "") {
                ...
                Pace.track(function () {
                    $.ajax({
                        url: "BRidPossessionStatusUpdated?action=showUnionWise",
                        data: {
                            districtId: districtId,
                            upazilaId: upazilaId,
                            unionId: unionId,
...
//                                            + "<td id='rightAlign'>" + json[i].eligible + "</td>"
                                    ...
                                    //                                        + "<td id='rightAlign'>" + json[i].registered + "</td>"
                                    //                                        + "<td id='rightAlign'>" + json[i].eligible + "</td>"
                                    //                                        + "<td id='rightAlign'>" + json[i].havenbrid + "</td>"
                                    //                                        + "<td id='rightAlign'>" + json[i].percent + "</td>"
                                    //                                        + "<td id='rightAlign'>" + json[i].never_had + "</td>"
                                    //                                        + "<td id='rightAlign'><a href='viewNidMissing?districtId="+districtId+"&upazilaId="+json[i].upazilaid+"&unionId="+json[i].unionid+"&sDate="+getDateFormat(startDate)+"&eDate="+getDateFormat(endDate)+"' target='_blank'><b>" + json[i].lost + "</b></a></td>" //class='btn btn-primary btn-xs'
                                    //                                        + "<td id='rightAlign'>" + json[i].cant_locate + "</td>"
                                    //                                        + "<td id='rightAlign'>" + json[i].kept_in_other_place + "</td>"
...
//======PRS Report Provider Wise===============================================================================================
        $('#showProviderPRS').click(function () {
            ...
            if (divisionId === "") {
                ...
                Pace.track(function () {
                    $.ajax({
                        url: "BRidPossessionStatusUpdated?action=prsProgressProviderWise",
                        data: {
                            districtId: districtId,
                            upazilaId: upazilaId,
                            unionId: unionId,
                            ...
                            if (json.length === 0) {
                                ...
                                for (var i = 0; i < json.length; i++) {
                                    ...
                                    var parsedData = "<tr><td>" + (i + 1) + "</td>"
                                            ...
                                            + "<td class='numeric_field'>" + finiteFilter(parseFloat((json[i].have_brid / json[i].population * 100).toFixed(2))) + "</td>"
                                            + "<td class='numeric_field'>" + finiteFilter(parseFloat((json[i].dont_have / json[i].population * 100).toFixed(2))) + "</td>"
                                            + "<td class='numeric_field'>" + finiteFilter(parseFloat((json[i].missing / json[i].population * 100).toFixed(2))) + "</td>"
                                            + "<td class='numeric_field'>" + finiteFilter(parseFloat((json[i].not_found / json[i].population * 100).toFixed(2))) + "</td>"
                                            + "<td class='numeric_field'>" + finiteFilter(parseFloat((json[i].other_place / json[i].population * 100).toFixed(2))) + "</td>"
                                            + "<td class='numeric_field'>" + finiteFilter(parseFloat((json[i].not_citizen / json[i].population * 100).toFixed(2))) + "</td>"
                                            + "</tr>";
                                ...
                                var footerData = "<tr> <td style='text-align:left' colspan='7'>Total</td>"
                                        ...
                                        + "<td class='numeric_field'>" + parseFloat((cal.sum.have_brid / cal.sum.population * 100).toFixed(2)) + "</td>"
                                        + "<td class='numeric_field'>" + parseFloat((cal.sum.dont_have / cal.sum.population * 100).toFixed(2)) + "</td>"
                                        + "<td class='numeric_field'>" + parseFloat((cal.sum.missing / cal.sum.population * 100).toFixed(2)) + "</td>"
                                        + "<td class='numeric_field'>" + parseFloat((cal.sum.not_found / cal.sum.population * 100).toFixed(2)) + "</td>"
                                        + "<td class='numeric_field'>" + parseFloat((cal.sum.other_place / cal.sum.population * 100).toFixed(2)) + "</td>"
                                        + "<td class='numeric_field'>" + parseFloat((cal.sum.not_citizen / cal.sum.population * 100).toFixed(2)) + "</td></tr>";
        ...
        function makePiChart(HaveBRIDCardData, NeverHadData, LostData, CantLocateData, KeptInOtherPlaceData, NotCitizenData) {
            Highcharts.chart('container', {
                ...
                colors: ['#126aba', '#e55959', '#e5a51b', '#7ab2ef', '#7f8184', '#73b7ce'],
                plotOptions: {
                    pie: {
                ...
                series: [{
                        ...
                        data: [{
                                ...
                                name: 'Kept in other place',
                                y: KeptInOtherPlaceData[0]
                            }, {
                                name: 'Not citizen',
                                y: NotCitizenData[0]
                            }]
...
//              type: 'pie',
//              data: {
//                labels: ["Have NID card", "Never had", "Lost", "Can't locate", "Kept in other place", "Not citizen"],
//                datasets: [{
//                  backgroundColor: [
//                    "#126aba",
//                    "#e55959",
...
//                    "#73b7ce"
//                  ],
//                  data: [HaveNIDCardData, NeverHadData, LostData, CantLocateData, KeptInOtherPlaceData, NotCitizenData]
//                }]
//              }
//            });
        }
        ...
        //Make chart by Data
        function  makeChart(area, HaveBRIDCardData, NeverHadData, LostData, CantLocateData, KeptInOtherPlaceData, NotCitizenData) {

            //Arrange data for graph/chart
            var data = [{
                    label: 'Have BRID card',
                    backgroundColor: "#126aba",
                    yAxisID: "bar-y-axis",
                    data: HaveBRIDCardData
                }, {
                    label: 'Never had',
                    ...
                    label: 'Lost',
                    backgroundColor: "#e5a51b",
                    yAxisID: "bar-y-axis",
                    data: LostData
                }, {
                    label: "Can't locate",
                    backgroundColor: "#7ab2ef",
                    yAxisID: "bar-y-axis",
                    data: CantLocateData
                }, {
                    label: 'Kept in other place',
                    backgroundColor: "#7f8184",
                    yAxisID: "bar-y-axis",
                    data: KeptInOtherPlaceData
                }, {
                    label: 'Not citizen',
                    backgroundColor: "#73b7ce",
                    yAxisID: "bar-y-axis",
                    data: NotCitizenData
                }];
...
<section class="content-header">
    <h1>Possession of Birth Registration Card</h1>
</section>
