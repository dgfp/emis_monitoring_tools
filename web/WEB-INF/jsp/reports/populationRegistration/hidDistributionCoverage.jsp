...
//==============================Table View District wise
                                ...
                                for (var i = 0; i < json.length; i++) {
                                    ...
                                    var parsedData = "<tr id='tableRow'><td>" + (i + 1) + "</td>"
                                            ...
                                            + "<td class='numeric_field'>" + row.household+ "</td>"
                                            + "<td class='numeric_field'>" + ((row.all_received*100)/row.household).toFixed(2) + "</td>"
                                            + "<td class='numeric_field'>" + ((row.partial_received*100)/row.household).toFixed(2) + "</td>"
                                            + "<td class='numeric_field'>" + (((row.household - row.all_received - row.partial_received)*100)/row.household).toFixed(2) + "</td>"
                                            + "<td class='numeric_field'>" + row.population + "</td>"
                                            + "<td class='numeric_field'>" + (100 - ((row.population_received_hid*100)/row.population)).toFixed(2) + "</td>"
                                            + "</tr>";
                                ...
                                var footerData = "<tr id='tableRow'> <td style='text-align:left' colspan='2'>Total</td>"
                                        + "<td class='numeric_field'>" + cal.sum.household + "</td>"
                                        + "<td class='numeric_field'>" + ((cal.sum.all_received*100)/cal.sum.household).toFixed(2) + "</td>"
                                        + "<td class='numeric_field'>" + ((cal.sum.partial_received*100)/cal.sum.household).toFixed(2) + "</td>"
                                        + "<td class='numeric_field'>" + (((cal.sum.household - cal.sum.all_received - cal.sum.partial_received)*100)/cal.sum.household).toFixed(2) + "</td>"
                                        + "<td class='numeric_field'>" + cal.sum.population + "</td>"
                                        + "<td class='numeric_field'>" + (100 - ((cal.sum.population_received_hid*100)/cal.sum.population)).toFixed(2) + "</td>"
                                        + "</tr>";
