<%-- 
    Document   : ProviderWisePRS
    Created on : Nov 17, 2019, 3:15:39 PM
    Author     : Helal
--%>
...
<section class="content-header">
    <h1>Provider wise performance<small></small></h1>
</section>
                ...
                <div class="box-body" >
                    <div class="nav-tabs-custom" style="margin-top:  -10px;margin-bottom:  -9px;">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="#providerWise" data-toggle="tab" onclick='resetArea("Provider")'>Progress of registration</a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <!--------------------------Union Wise---------------------------------------------------->    
                            <!--------------------------Provider Wise---------------------------------------------------->               
                            <div class="tab-pane active" id="providerWise">
                                <div class="row">
