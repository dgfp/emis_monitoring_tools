<%-- 
    Document   : birthHa
    Created on : Dec 14, 2017, 12:40:08 PM
...
//================================================END===================================== 
        $.hereWeGo=function (context){
            $(context).parentsUntil('.col-md-12').remove();
        }
...
//                                                + "<td>" + json[i].union + "</td>"
                    ...
                    if(upazilaId=="0"){
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "BirthHA?action=AggregateUpazila",
                                data: {
                    ...
                    //Union wise aggregate    
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "BirthHA?action=AggregateUnion",
                                data: {
                                    districtId: $("select#district").val(),
                    ...
                    //Ward wise aggregate    
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "BirthHA?action=AggregateWard",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "BirthHA?action=AggregateVillage",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                                    unionId: $("select#union").val(),
...
<section class="content-header">
  ...
  <ol class="breadcrumb" id="communityStatisticsAccessHF">
    <a class="btn btn-flat btn-primary btn-sm" href="birth"><i class="fa fa-users" aria-hidden="true"></i> <b>&nbsp;Family Planning</b></a>
    <a class="btn btn-flat btn-info btn-sm" href="BirthHA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-heartbeat" aria-hidden="true"></i> <b>&nbsp;Health&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
  </ol>
</section>
