             ...
             if( $("select#division").val()=="" || $("select#division").val()==0){
                ...
                if (reportType=== "individual") {
                    if( $("select#district").val()=="" || $("select#district").val()==0){
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman?action=Individual",
                                data: {
...
//                                            + "<th style='vertical-align: top;'>Union</th>"
                                    ...
                                    for (var i = 0; i < json.length; i++) {
                                        ...
                                        var husbandName = nullConverter(json[i].husband);
...
//                                                + "<td>" + json[i].union + "</td>"
                    ...
                    if(upazilaId=="0"){
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman?action=AggregateUpazila",
                                data: {
                    ...
                    //Union wise aggregate    
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman?action=AggregateUnion",
                                data: {
                                    districtId: $("select#district").val(),
                    ...
                    //Unit wise aggregate    
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman?action=AggregateUnit",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman?action=AggregateVillage",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                                    unionId: $("select#union").val(),
        ...
        function generateAggregateTable(json,viewType){
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                var parsedData = "<tr><td>" + (i + 1) + "</td>"
                        ...
                        + "<td>" + ((json[i].reg_women === "null") ? "0" : json[i].reg_women) + "</td>"
                        + "<td> - </td>";
                tableBody.append(parsedData);
                tableBodyP.append(parsedData);
...
<section class="content-header">
  <h1><span style="color:#4fef2f;"><i class="fa fa-check-circle" aria-hidden="true"></i></span> Women registration coverage for EPI</h1>
  <ol class="breadcrumb" id="communityStatisticsAccessHF">
    <a class="btn btn-flat btn-info btn-sm" href="immunization_woman"><i class="fa fa-users" aria-hidden="true"></i> <b>&nbsp;Family Planning</b></a>
    <a class="btn btn-flat btn-primary btn-sm" href="immunization_woman_ha">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-heartbeat" aria-hidden="true"></i> <b>&nbsp;Health&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
  </ol>
</section>
