...
<script>
    $(function () {
        if ($.app.individualAceess.indexOf($.app.user.role) < 0 && $.app.user.username!="program_manager") {
            ...
            //$(".btn-label").addClass("col-md-offset-9").addClass("col-xs-offset-6");
        }
    });
</script>
<style>
...
//======Make CSV export using these function=====================================================
        /*function exportTableToCSV($table, filename) {
         ...
         // Data URI
         var csvData = 'data:application/text;charset=utf-8,' + encodeURIComponent(csv);
...
//================================================END=====================================        
        ...
        $('#showdataButton').click(function () {
            ...
            if (reportType === "overall") {
                ...
                Pace.track(function () {
                    $.ajax({
                        url: "elco_details?action=Individual",
                        data: {
