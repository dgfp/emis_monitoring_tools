...
//                    }
                    ...
                    Pace.track(function(){
                        $.ajax({
                            url: "pregnantHA?action=Individual",
                            data: {
...
//                                areaText=division +',&nbsp;&nbsp;'+ district +',&nbsp;&nbsp;'+ upazila +',&nbsp;&nbsp;'+union+'&nbsp;&nbsp;'+unit+'&nbsp;&nbsp;'+village+'&nbsp;&nbsp;'+sDate+'&nbsp;&nbsp;'+eDate;
                                ...
                                for (var i = 0; i < json.length; i++) {
                                    ...
                                    var parsedData = "<tr style='width:10px!importtant'><td>" + (i + 1) + "</td>"
                                            ...
                                            + "<td>" + moment(json[i].lmp).format('DD MMM YYYY') + "</td>"
                                            + "<td>" + moment(json[i].edd).format('DD MMM YYYY')+ "</td>"
                                ...
                                for (var i = 0; i < individualJsonCompleted.length; i++) {
                                    ...
                                    var parsedData = "<tr style='width:10px!importtant'><td>" + (serial + i) + "</td>"
                                            ...
                                            + "<td>" + ((individualJsonCompleted[i].elcono === "null") ? "-" : individualJsonCompleted[i].elcono)  + "</td>"
                                            + "<td>" + individualJsonCompleted[i].nameeng + "</td>"
                                            + "<td>" + individualJsonCompleted[i].age + "</td>"
                                            ...
                                            + "<td>" + moment(individualJsonCompleted[i].lmp).format('DD MMM YYYY') + "</td>"
                                            + "<td>" + moment(individualJsonCompleted[i].edd).format('DD MMM YYYY') + "</td>"
                    ...
                    if(upazilaId=="0"){
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "pregnantHA?action=AggregateUpazila",
                                data: {
...
//=========================================Union wise aggregate=======================================================
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "pregnantHA?action=AggregateUnion",
                                data: {
                                    districtId: $("select#district").val(),
...
//========================================Unit wise aggregate   =================================================
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "pregnantHA?action=AggregateWard",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
...
//=========================================================== Village wise aggregate =======================================================                       
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "pregnantHA?action=AggregateVillage",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                                    unionId: $("select#union").val(),
        ...
        $('#individualViewType').change(function (event) {
            ...
            if(viewType=="completed"){
                ...
                $('#all').html("<span class='label label-flat label-primary label-xs'><b>"+ (active+due) +"</b></span>");
                var table = $('#data-table').DataTable();
                table.draw();
...
<section class="content-header">
    ...
    <ol class="breadcrumb" id="communityStatisticsAccessHF">
      <a class="btn btn-flat btn-primary btn-sm" href="pregnant"><i class="fa fa-users" aria-hidden="true"></i> <b>&nbsp;Family Planning</b></a>
      <a class="btn btn-flat btn-info btn-sm" href="pregnantHA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-heartbeat" aria-hidden="true"></i> <b>&nbsp;Health&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
    </ol>
</section>
<!-- Main content -->
        ...
        <div class="box-header with-border" style="margin-top: -8px;margin-bottom: -5px!important;">
            <h3 class="box-title" style="text-align: center!important;">
                ...
                <div class="box-tools pull-right" style="margin-top: 0px;">
                    <button id="printTableBtn" type="button" class="btn btn-box-tool"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Print / PDFss</button>
