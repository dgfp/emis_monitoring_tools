                            ...
                            $.ajax({
                                ...
                                success: function (result) {
                                    ...
                                    var parsedHeader = "<tr>"
                                            ...
                                            + "<th style='vertical-align: top;'>Registered Pregnant</th>"
                                    ...
                                    for (var i = 0; i < json.length; i++) {
                                        ...
                                        var parsedData = "<tr><td>" + (i + 1) + "</td>"
                                                ...
                                                + "<td>" + ((json[i].reg_preg === "null") ? "0" : json[i].reg_preg) + "</td>"
                                                + "<td> - </td>";
                                        tableBody.append(parsedData);
                                        tableBodyP.append(parsedData);
                                    ...
                                    + "<td id='rightAlign'>" + registered_pregnant_sum + "</td>"
                                    + "<td id='rightAlign'>-</td>";
            ...
            if(viewType=="completed"){
                ...
                for (var i = 0; i < individualJsonCurrent.length; i++) {
                    ...
                    var parsedData = "<tr style='width:10px!importtant'><td>" + (i + 1) + "</td>"
                            ...
                            + "<td>" + moment(individualJsonCurrent[i].lmp).format('DD MMM YYYY')  + "</td>"
                            + "<td>" + moment(individualJsonCurrent[i].edd).format('DD MMM YYYY')  + "</td>"
                            + "<td class='center'>" + status + "</td>";
                    tableBody.append(parsedData);
                    tableBodyP.append(parsedData);
                }
