...
//======Export CSV using these function==========================================================
        $("#exportText").click(function (event) {
            var outputFile = "eMIS_infant_registration_coverage_for_epi ";
             ...
             if( $("select#division").val()=="" || $("select#division").val()==0){
                ...
                if (reportType=== "individual") {
                    if( $("select#district").val()=="" || $("select#district").val()==0){
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_infant_ha?action=Individual",
                                data: {
...
//                                                + "<td>" + json[i].union + "</td>"
                    ...
                    if(upazilaId=="0"){
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_infant_ha?action=AggregateUpazila",
                                data: {
                    ...
                    //Union wise aggregate    
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_infant_ha?action=AggregateUnion",
                                data: {
                                    districtId: $("select#district").val(),
                    ...
                    //Ward wise aggregate    
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_infant_ha?action=AggregateWard",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_infant_ha?action=AggregateVillage",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                                    unionId: $("select#union").val(),
...
//                    + "<th style='vertical-align: top;'>Progress(%)</th>"
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                var parsedData = "<tr><td>" + (i + 1) + "</td>"
                        ...
                        + "<td id='rightAlign'>" + ((json[i].reg_infant === "null") ? "0" : json[i].reg_infant) + "</td>"
                        + "</tr>";
                tableBody.append(parsedData);
                tableBodyP.append(parsedData);
...
<section class="content-header">
  <h1>EPI: Infant registration </h1>
<!--  <ol class="breadcrumb" id="communityStatisticsAccessHF">
    <a class="btn btn-flat btn-primary btn-sm" href="immunization_infant"><i class="fa fa-users" aria-hidden="true"></i> <b>&nbsp;Family Planning</b></a>
    <a class="btn btn-flat btn-info btn-sm" href="immunization_infant_ha">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-heartbeat" aria-hidden="true"></i> <b>&nbsp;Health&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
  </ol>-->
</section>
