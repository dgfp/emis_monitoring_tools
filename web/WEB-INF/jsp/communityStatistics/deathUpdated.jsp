...
//                                            + "<td>" + json[i].union + "</td>"
 ...
 //=========================================================Upazila wise aggregate==========================================================
                    if(upazilaId=="0"){
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "death?action=AggregateUpazila",
                                data: {
                                ...
                                success: function (result) {
                                    ...
                                    for (var i = 0; i < json.length; i++) {
                                        ...
                                        var parsedData = "<tr><td>" + (i + 1) + "</td>"
                                                ...
                                                + "<td>" + ((json[i].reg_death === "null") ? "0" : json[i].reg_death) + "</td>"
                                                + "<td> - </td>";
                                        tableBody.append(parsedData);
                                        tableBodyP.append(parsedData);
                                    ...
                                    + "<td id='rightAlign'>" + registered_death_sum + "</td>"
                                    + "<td id='rightAlign'>-</td>";
...
//======================================================Union wise aggregate===========================================================
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "death?action=AggregateUnion",
                                data: {
                                    districtId: $("select#district").val(),
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "death?action=AggregateUnit",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "death?action=AggregateVillage",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                                    unionId: $("select#union").val(),
...
<!--      <ol class="breadcrumb" id="communityStatisticsAccessHF">
        <a class="btn btn-flat btn-info btn-sm" href="death"><i class="fa fa-users" aria-hidden="true"></i> <b>&nbsp;Family Planning</b></a>
        <a class="btn btn-flat btn-primary btn-sm" href="deathHA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-heartbeat" aria-hidden="true"></i> <b>&nbsp;Health&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
      </ol>-->
</section>
