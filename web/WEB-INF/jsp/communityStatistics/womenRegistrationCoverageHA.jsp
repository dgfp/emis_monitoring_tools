...
//======Print & PDF Data
        $('#printTableBtn').click(function () {
            ...
            frameDoc.document.write('<h3 style="margin-bottom:-12px;text-align:center!important;"><center>Women registration coverage for EPI</center></h3>');
...
//======Export CSV using these function==========================================================
        $("#exportText").click(function (event) {
            var outputFile = "eMIS_women_registration_coverage_for_epi";
             ...
             if( $("select#division").val()=="" || $("select#division").val()==0){
                ...
                if (reportType=== "individual") {
                    if( $("select#district").val()=="" || $("select#district").val()==0){
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman_ha?action=Individual",
                                data: {
...
//                                            + "<th style='vertical-align: top;'>Union</th>"
                                            ...
                                            + "<th style='vertical-align: top;'>Husband Name</th>"
                                    ...
                                    for (var i = 0; i < json.length; i++) {
                                        ...
                                        var husbandName = nullConverter(json[i].husbandname);
...
//                                                + "<td>" + json[i].union + "</td>"
                                                ...
                                                + "<td class='area'>" + json[i].age + "</td>"
                                                + "<td class='area'>" + husbandName + "</td>"
                    ...
                    if(upazilaId=="0"){
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman_ha?action=AggregateUpazila",
                                data: {
                    ...
                    //Union wise aggregate    
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman_ha?action=AggregateUnion",
                                data: {
                                    districtId: $("select#district").val(),
                    ...
                    //Ward wise aggregate    
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman_ha?action=AggregateWard",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                        ...
                        Pace.track(function(){
                            $.ajax({
                                url: "immunization_woman_ha?action=AggregateVillage",
                                data: {
                                    districtId: $("select#district").val(),
                                    upazilaId: $("select#upazila").val(),
                                    unionId: $("select#union").val(),
        ...
        function generateAggregateTable(json,viewType){
            ...
            var parsedHeader = "<tr>"
                    ...
                    + "<th style='vertical-align: top;'>Registered Woman</th>"
//                    + "<th style='vertical-align: top;'>Progress(%)</th>"
            ...
            tableBody.empty();
            //------Bottom Sum------
            var registered_population_sum = 0, reg_women_sum = 0, progress_sum= 0;
            //----------------------
            for (var i = 0; i < json.length; i++) {
                ...
                var parsedData = "<tr><td>" + (i + 1) + "</td>"
                        ...
                        + "<td id='rightAlign'>" + ((json[i].reg_women === "null") ? "0" : json[i].reg_women) + "</td>"
                        + "</tr>";
                tableBody.append(parsedData);
                tableBodyP.append(parsedData);
...
<section class="content-header">
  <h1> EPI: woman registration </h1>
<!--  <ol class="breadcrumb" id="communityStatisticsAccessHF">
    <a class="btn btn-flat btn-primary btn-sm" href="immunization_woman"><i class="fa fa-users" aria-hidden="true"></i> <b>&nbsp;Family Planning</b></a>
    <a class="btn btn-flat btn-info btn-sm" href="immunization_woman_ha">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-heartbeat" aria-hidden="true"></i> <b>&nbsp;Health&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
  </ol>-->
</section>
