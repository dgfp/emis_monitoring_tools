<%-- 
    Document   : AssetDashboard
    Created on : Oct 18, 2020, 11:40:26 AM
    Author     : Helal
--%>
...
<section class="content">
            ...
            <div class="box full-screen">
                ...
                <div class="box-body">
                    <h3 class="viewTitle center box-body-title">
                        <span class="label label-default">Procurement and projection</span>
                    </h3>
                    <div class="tab-content no-padding">
                        <div class="row tab-pane active" id="tablet-stock-status-table">
                            <div class="col-md-10 col-md-offset-1">
                                <table id="tablet_stock_status" class="table">
                                    <thead>
                                    </thead>
                                    <tbody id="tableBody">
                                    </tbody>
        ...
        <div class="col-md-12" id="tablet_stock_status_link">
            <div class="box full-screen">
                <div class="box-header with-border" style="padding: 0px;">
                    <p class="box-title bold" style="font-size: 15px;padding: 2px;padding-left: 5px;"></p>
                    <p class="box-title" id="tablet_stock_status_title" style="font-size: 14px;">
                        <a href="#age-of-tablet-table" class="btn btn-flat btn-primary btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-table" aria-hidden="true"></i>&nbsp;Table</a>
                        <a href="#age-of-tablet-chart" class="btn btn-flat btn-default btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;Chart</a>
                    </p>
                    <div class="box-tools pull-right" style="margin-top: -10px;">
                        <button type="button" class="btn btn-box-tool" id="panel-fullscreen"><i class="fa fa-expand" aria-hidden="true"></i></button>
                    </div>
                ...
                <div class="box-body">
                    <h3 class="viewTitle center box-body-title">
                        <span class="label label-default">Device age profiles</span>
                    </h3>
                    <div class="tab-content no-padding">
                        <div class="row tab-pane active" id="age-of-tablet-table">
                            <div class="col-md-10 col-md-offset-1">
                                <table id="age_of_tablet" class="table">
                                    <thead>
                                    </thead>
                                    <tbody id="tableBody">
                                    </tbody>
        ...
        <div class="col-md-12" id="tablet_stock_status_link">
            <div class="box full-screen">
                <div class="box-header with-border" style="padding: 0px;">
                    <p class="box-title bold" style="font-size: 15px;padding: 2px;padding-left: 5px;"></p>
                    <p class="box-title" id="tablet_stock_status_title" style="font-size: 14px;">
                        <a href="#projected-purchase-need-table" class="btn btn-flat btn-primary btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-table" aria-hidden="true"></i>&nbsp;Table</a>
                        <a href="#projected-purchase-need-chart" class="btn btn-flat btn-default btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;Chart</a>
                    </p>
                    <div class="box-tools pull-right" style="margin-top: -10px;">
                        <button type="button" class="btn btn-box-tool" id="panel-fullscreen"><i class="fa fa-expand" aria-hidden="true"></i></button>
                    </div>
                ...
                <div class="box-body">
                    ...
                    <div class="tab-content no-padding">
                        <div class="row tab-pane active" id="projected-purchase-need-table">
                            <div class="col-md-10 col-md-offset-1">
                                <table id="projected_purchase_need" class="table">
                                    <thead>
                                    </thead>
                                    <tbody id="tableBody">
                                    </tbody>
        ...
        <div class="col-md-12" id="tablet_stock_status_link">
            <div class="box full-screen">
                <div class="box-header with-border" style="padding: 0px;">
                    <p class="box-title bold" style="font-size: 15px;padding: 2px;padding-left: 5px;"></p>
                    <p class="box-title" id="tablet_stock_status_title" style="font-size: 14px;">
                        <a href="#tablet-functionality-status-table" class="btn btn-flat btn-primary btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-table" aria-hidden="true"></i>&nbsp;Table</a>
                        <a href="#tablet-functionality-status-chart" class="btn btn-flat btn-default btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;Chart</a>
                    </p>
                    <div class="box-tools pull-right" style="margin-top: -10px;">
                        <button type="button" class="btn btn-box-tool" id="panel-fullscreen"><i class="fa fa-expand" aria-hidden="true"></i></button>
                    </div>
                ...
                <div class="box-body">
                    <h3 class="viewTitle center box-body-title">
                        <span class="label label-default">Functionalities</span>
                    </h3>
                    <div class="tab-content no-padding">
                        <div class="row tab-pane active" id="tablet-functionality-status-table">
                            <div class="col-md-10 col-md-offset-1">
                                <table id="tablet_functionality_status" class="table">
                                    <thead>
                                    </thead>
                                    <tbody id="tableBody">
                                    </tbody>
        ...
        <div class="col-md-12" id="tablet_stock_status_link">
            <div class="box box-primary full-screen">
                <div class="box-header with-border" style="padding: 0px;">
                    <p class="box-title bold" style="font-size: 15px;padding: 2px;padding-left: 5px;"></p>
                    <p class="box-title" id="tablet_stock_status_title" style="font-size: 14px;">
                        <a href="#tablet-status-by-warranty-period-table" class="btn btn-flat btn-primary btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-table" aria-hidden="true"></i>&nbsp;Table</a>
                        <a href="#tablet-status-by-warranty-period-chart" class="btn btn-flat btn-default btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;Chart</a>
                    </p>
                    <div class="box-tools pull-right" style="margin-top: -10px;">
                        <button type="button" class="btn btn-box-tool" id="panel-fullscreen"><i class="fa fa-expand" aria-hidden="true"></i></button>
                    </div>
                ...
                <div class="box-body">
                    <h3 class="viewTitle center box-body-title">
                        <span class="label label-default">Acquisition and warranties</span>
                    </h3>
                    <div class="tab-content no-padding" style="margin-bottom: 15px;">
                        <div class="row tab-pane active" id="tablet-status-by-warranty-period-table">
                            <div class="col-md-10 col-md-offset-1">
                                <table id="tablet_status_by_warranty_period" class="table">
                                    <thead>
                                    </thead>
                                    <tbody id="tableBody">
                                    </tbody>
        ...
        <div class="col-md-12" id="tablet_stock_status_link">
            <div class="box box-primary full-screen">
                <div class="box-header with-border" style="padding: 0px;">
                    <p class="box-title bold" style="font-size: 15px;padding: 2px;padding-left: 5px;"></p>
                    <p class="box-title" id="tablet_stock_status_title" style="font-size: 14px;">
                        <a href="#tablet-repair-status-table" class="btn btn-flat btn-primary btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-table" aria-hidden="true"></i>&nbsp;Table</a>
                        <a href="#tablet-repair-status-chart" class="btn btn-flat btn-default btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;Chart</a>
                    </p>
                    <div class="box-tools pull-right" style="margin-top: -10px;">
                        <button type="button" class="btn btn-box-tool" id="panel-fullscreen"><i class="fa fa-expand" aria-hidden="true"></i></button>
                    </div>
                ...
                <div class="box-body">
                    <h3 class="viewTitle center box-body-title">
                        <span class="label label-default">Delisted from stock</span>
                    </h3>
                    <div class="tab-content no-padding">
                        <div class="row tab-pane active" id="tablet-repair-status-table">
                            <div class="col-md-10 col-md-offset-1">
                                <table id="tablet_repair_status" class="table">
                                    <thead>
                                    </thead>
                                    <tbody id="tableBody">
                                    </tbody>
    ...
    <div class="row main">
        <div class="col-md-12" id="number_of_tablets_lost_link">
            <div class="box box-primary full-screen">
                <div class="box-header with-border" style="padding: 0px;">
                    <p class="box-title bold" style="font-size: 15px;padding: 2px;padding-left: 5px;"></p>
                    <p class="box-title" id="tablet_stock_status_title" style="font-size: 14px;">
                        <a href="#number-of-tablets-lost-table" class="btn btn-flat btn-primary btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-table" aria-hidden="true"></i>&nbsp;Table</a>
                        <a href="#number-of-tablets-lost-chart" class="btn btn-flat btn-default btn-xs bold btn-tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-bar-chart" aria-hidden="true"></i>&nbsp;Chart</a>
                    </p>
                    <div class="box-tools pull-right" style="margin-top: -10px;">
                        <button type="button" class="btn btn-box-tool" id="panel-fullscreen"><i class="fa fa-expand" aria-hidden="true"></i></button>
                    </div>
                ...
                <div class="box-body">
                    <h3 class="viewTitle center box-body-title">
                        <span class="label label-default">Number of tablets lost</span>
                    </h3>
                    <div class="tab-content no-padding">
                        <div class="row tab-pane active" id="number-of-tablets-lost-table">
                            <div class="col-md-10 col-md-offset-1">
                                <table id="number_of_tablets_lost" class="table">
                                    <thead>
                                    </thead>
                                    <tbody id="tableBody">
                                    </tbody>
            ...
            column: function (name) {
                ...
                var column = {
                    tablet_stock_status: [
                        ...
                        {data: "tablet_purchased", title: "Procured (Last 3 years)"},
                        {data: function (d) {
...
//                            }, title: " Expiration date"},
            ...
            title: {
                tablet_stock_status: "Procurement and projection",
