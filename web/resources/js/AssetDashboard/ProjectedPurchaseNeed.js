$(document).ready(function () {
    ...
    $('#division3').change(function (event) {
        ...
        var division3Id = $("select#division3").val();

        if (division3Id === "" || division3Id === '0') {
            var selectTag = $('#district3');
            selectTag.find('option').remove();
            $('<option>').val("0").text('All').appendTo(selectTag);

            var selectTagUpazila = $('#upazila3');
    ...
    //Load Upazila from district3------------------------------------------------
    $('#district3').change(function (event) {

        var district3Id = $("select#district3").val();
        var selectTag = $('#upazila3');

        if (district3Id === "" || district3Id === '0') {
