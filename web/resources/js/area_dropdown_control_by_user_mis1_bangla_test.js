$(document).ready(function () {
    var divid = "#division",  zillaid = "#district", upazilaid= "#upazila", unionid = "#union", unitid = "#unit", providerid = "#provCode", month = "#month", year = "#year";
    ...
    $('#union').change(function (event) {
        ...
        if (unionId === "" || unionId === '0') {
            ...
            $.ajax({
                ...
                type: 'POST',
                success: function (response) {//console.log("response_mn",response);
                    ...
                    $('<option>').val("").text('- সিলেক্ট ইউনিট  -').appendTo(selectTagUnit);
                ...
                error: function (response) { console.log("response_fail",response);
    ...
    $('#unit').change(function (event) {
        ...
        if (unitId === "" || unitId === '0') {
            ...
            $.get('ProviderJsonProviderByUnitTest', {
