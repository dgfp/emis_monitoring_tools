$(document).ready(function () {
    ...
    function loadUpazila() {
        $.get("UpazilaJsonProviderByUser", function (response) {
            ...
            if (returnedData.length > 1 && $('#userDesignation').val() != "DDFP") {
                $('<option>').val("").text('- Select Union -').appendTo(selectTag);
            } else if (returnedData.length > 1 && $('#userDesignation').val() == "DDFP") {
                $('<option>').val("").text('All').appendTo(selectTag);
            }
    ...
    function loadUnion() {
        $.get("UnionJsonProviderByUser", function (response) {
            ...
            if (returnedData.length > 1 && $('#userDesignation').val() != "UFPO") {
                $('<option>').val("").text('- Select Union -').appendTo(selectTag);
            } else if (returnedData.length > 1 && $('#userDesignation').val() == "UFPO") {
                $('<option>').val("").text('All').appendTo(selectTag);
            }
